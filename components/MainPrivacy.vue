<template>
  <div class="container">
    ...
    <ul class="no-style">
      <li>
        <h4 class="h6">
          <em>Who is responsible for the data collection on this website?</em>
        </h4>
      ...
      <li>
        <h4 class="h6">
          <em>How do we collect your data?</em>
        </h4>
      ...
      <li>
        <h4 class="h6">
          <em>What do we use your data for?</em>
        </h4>
      ...
      <li>
        <h4 class="h6">
          <em>What rights do you have regarding your data?</em>
        </h4>
    ...
    <p>The party responsible for processing data on this website is: The responsible party is the natural or legal person who alone or jointly with others decides on the purposes and means of processing personal data (names, email addresses, etc.).</p>
